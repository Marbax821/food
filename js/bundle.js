...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _services_srvices__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/srvices */ "./js/services/srvices.js");
...
function cards() {
    ...
    class MenuCard {
        ...
        render() {
            ...
            } else if (this.classes[0] !== "menu__item") {
    ...
    //* 1-й вариант создания элементов с классами
    (0,_services_srvices__WEBPACK_IMPORTED_MODULE_0__.getResourse)('http://localhost:3000/menu')
        .then(data => {
...
/* harmony import */ var _services_srvices__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/srvices */ "./js/services/srvices.js");
...
function forms(formSelector, modalTimerId) {
    ...
    function bindPostData(form) {
        form.addEventListener('submit', (e) => {
            ...
            (0,_services_srvices__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3000/requests', json)
                .then(data => {
                    console.log(data);
...
function slider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
    ...
    const indicators = document.createElement('ol'),
        dots = [];
    indicators.classList.add('carousel-indocators');
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
    ...
    // если ф-ция будет вызвана без аргумента, то аргумент по умолчанию будет 0 (i = 0)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2023-09-1');
